--vytvoreni primatni tabulky t_jan_gondas_project_sql_primary_final
...
--select * from t_jan_gondas_project_sql_primary_final;
--drop table t_jan_gondas_project_sql_primary_final;

--vytvoreni view v_jan_gondas_project_sql_primary_final_payrolls za ucelem obecneho prehledu o vyvoji mezd v pozorovanem obdobi (razeno podle nazvu odvetvi a obdobi)
...
-- vytvoreni view v_jan_gondas_project_sql_primary_final_decreasing_payroll za ucelem filtrace odvetvi ktere kdykoliv behem sledovaneho obdobi vykazovaly sestupnou tendenci v ramci rustu mezd (razeno podle nazvu odvetvi a obdobi)
...
--vytvoreni view v_jan_gondas_project_sql_primary_final_milk_bread za ucelem vypoctu prumernych mezd a prumernych cen chleba a mleka a zaroven prepocet na maximalni dostupne mnozstvi techto potravin za prumernou mzdu v obdobi pro ktera mame dostupna potrebna data 
...
--vytvoreni view v_jan_gondas_project_sql_primary_final_slowest_rising_food za ucelem serazeni potravin od nejpomaleji zdrazujicich po nejpomaleji zdrazujici
...
--vytvoreni view v_jan_gondas_project_sql_primary_final_price_vs_salary_growth porovnavajici mezirocni narust (pokles) mezd a prumernych cen potravin, jejich procentualni porovnani a serazeni od nejvyssiho rozdilu mezi narustem cen potravin a mezd
...
--vytvoreni tabulky t_jan_gondas_project_sql_secondary_final sbirajici uzitecne udaje z tabulek countris a economies
...
--select * from t_jan_gondas_project_sql_secondary_final;
--drop table t_jan_gondas_project_sql_secondary_final;

--vytvoreni view v_jan_gondas_project_sql_secondary_final_hdp_vs_delayed_effect porovnavajici vyvoj hdp, rust mezd a cen potravin v ceske republice, serazeno podle let vzestupne
...
--drop view v_jan_gondas_project_sql_secondary_final_hdp_vs_delayed_effect;